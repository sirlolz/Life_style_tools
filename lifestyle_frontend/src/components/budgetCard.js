    ...
    render(){
        ...
        <div className="budget">
            ...
            <div className="raw-data">
                ...
                <button onClick={() => this.props.toggle()}>open edit budget</button>
            </div>
            {this.props.edit ? (<CreateBudget toggle={this.props.toggle} handleCreate={this.props.handleCreate}/>):(null)}
        </div>)
    }
}